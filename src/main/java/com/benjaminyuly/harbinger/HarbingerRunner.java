...
public class HarbingerRunner implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		setRepository.save(new Set("Dominion (Base Game)",
		...
		setRepository.save(new Set("Intrigue",
		...
		setRepository.save(new Set("Seaside",
		...
		setRepository.save(new Set("Alchemy",
		...
		setRepository.save(new Set("Prosperity",
		...
		setRepository.save(new Set("Cornucopia",
		...
		setRepository.save(new Set("Hinterlands",
		...
		setRepository.save(new Set("Dark Ages",
		...
		setRepository.save(new Set("Guilds",
		...
		setRepository.save(new Set("Adventures",
		...
		setRepository.save(new Set("Empires",
		...
		setRepository.save(new Set("Nocturne",
		...
		setRepository.save(new Set("Renaissance",
		...
		setRepository.save(new Set("Menagerie",
		...
		setRepository.save(new Set("Promo",
